...
class DIContainer {
    ...
    registerDependencies() {
        ...
        this.registerTransient('registerCustomerUseCase', () => {
            ...
            return new index_3.RegisterCustomerUseCase(this.resolve('customerRepository'), this.resolve('passwordHasher'), this.resolve('emailService'), this.resolve('authRepository'));
        });
        this.registerTransient('registerRestaurantOwnerUseCase', () => {
            console.log('DIContainer: Registering registerRestaurantOwnerUseCase');
            return new index_3.RegisterRestaurantOwnerUseCase(this.resolve('restaurantOwnerRepository'), this.resolve('passwordHasher'), this.resolve('emailService'), this.resolve('authRepository'));
        });
        ...
        this.registerTransient('getRestaurantOwnerProfileUseCase', () => {
            ...
            return new index_3.GetRestaurantOwnerProfileUseCase(this.resolve('restaurantOwnerRepository'));
        });
        this.registerSingleton('authController', () => {
            console.log('DIContainer: Registering authController');
            return new AuthController_1.AuthController(this.resolve('registerCustomerUseCase'), this.resolve('registerRestaurantOwnerUseCase'), this.resolve('customerLoginUseCase'), this.resolve('restaurantOwnerLoginUseCase'), this.resolve('uploadProfileImageUseCase'), this.resolve('updateRestaurantLocationUseCase'), this.resolve('getRestaurantOwnerProfileUseCase'));
        });
